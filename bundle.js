...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}var _core=require("@cycle/core"),_cycleSnabbdom=require("cycle-snabbdom"),_app=require("./src/app"),_app2=_interopRequireDefault(_app),drivers={DOM:(0,_cycleSnabbdom.makeDOMDriver)(".app")},_run=(0,_core.run)(_app2["default"],drivers),sinks=_run.sinks,sources=_run.sources;module.hot&&(module.hot.accept(),module.hot.dispose(function(){sinks.dispose(),sources.dispose()}));

},{"./src/app":24,"@cycle/core":2,"cycle-snabbdom":5}],2:[function(require,module,exports){
"use strict";
...
},{"rx":23}],3:[function(require,module,exports){
...
},{"rx":23}],5:[function(require,module,exports){
'use strict';
...
exports.ul = ul;
exports.video = video;
},{"./fromEvent":4,"./parseTree":6,"./utils":7,"fast.js/array/filter":8,"fast.js/array/map":9,"fast.js/array/reduce":10,"hyperscript-helpers":13,"matches-selector":14,"rx":23,"snabbdom":21,"snabbdom/h":15,"snabbdom/modules/attributes":17,"snabbdom/modules/class":18,"snabbdom/modules/props":19,"snabbdom/modules/style":20}],6:[function(require,module,exports){
'use strict';
...
},{"fast.js/array/filter":8,"fast.js/array/map":9,"rx":23}],7:[function(require,module,exports){
"use strict";
...
},{"../function/bindInternal3":11}],9:[function(require,module,exports){
'use strict';
...
},{"../function/bindInternal3":11}],10:[function(require,module,exports){
'use strict';
...
},{"../function/bindInternal4":12}],11:[function(require,module,exports){
'use strict';
...
},{"./is":16,"./vnode":22}],16:[function(require,module,exports){
module.exports = {
  array: Array.isArray,
...
"use strict";function renderImage(t,e,r,a){return(0,_cycleSnabbdom.img)(".cat",{key:r,props:{src:t,alt:t,height:"500",width:"400"},style:{opacity:"0",transform:"translateX("+440*(e+a)+"px)",delayed:{opacity:"1",transform:"translateX("+440*e+"px)"},remove:{opacity:"0",transform:"translateX("+440*(e-a)+"px)"}}})}function renderCarousel(t,e,r){var a=3;return(0,_cycleSnabbdom.div)(".carousel-images",t.slice(e,e+a).map(function(t,a){return renderImage(t,a,a+e,r)}))}function Carousel(t){var e=t.DOM,r=e.select(".next").events("click").map(function(t){return 1}),a=e.select(".previous").events("click").map(function(t){return-1}),o=r.merge(a).startWith(0),m=o.scan(function(t,e){return t+e}).startWith(0);return{DOM:_rx.Observable.combineLatest(m,o,function(t,e){return(0,_cycleSnabbdom.div)(".carousel",[(0,_cycleSnabbdom.button)(".previous",{props:{disabled:0===t}},"Previous"),(0,_cycleSnabbdom.button)(".next",{props:{disabled:t===catPictures.length-3}},"Next"),renderCarousel(catPictures,t,e)])}),scroll$:m}}function App(t){var e=t.DOM,r=Carousel({DOM:e}),a=["wow","what a cat!","did you see that one?","best cat eveer","fo realzies","awwwwwwwwwwwwwwwwww","awwwhhhhhhhhwwhwhwhwhhhhhhhhh","kitty!","I should check my neko atsume..."],o=r.scroll$.map(function(t){return a[t]});return{DOM:_rx.Observable.combineLatest(o,r.DOM,function(t,e){return(0,_cycleSnabbdom.div)(".example",[e,(0,_cycleSnabbdom.div)(".text",t)])})}}Object.defineProperty(exports,"__esModule",{value:!0}),exports["default"]=Carousel,exports["default"]=App;var _rx=require("rx"),_cycleSnabbdom=require("cycle-snabbdom"),catPictures=["http://25.media.tumblr.com/Jjkybd3nScerz2jsjvrqDPix_400.jpg","http://25.media.tumblr.com/tumblr_lny14qJ7Wu1qdth8zo1_1280.jpg","http://25.media.tumblr.com/tumblr_mbo4u98wvQ1qhwmnpo1_1280.jpg","http://30.media.tumblr.com/tumblr_m26a45YwZA1r6t7tvo1_500.gif","http://25.media.tumblr.com/tumblr_m2x23lyfit1qzo3c9o1_1280.jpg","http://24.media.tumblr.com/tumblr_lz6q15mm8o1qgjltdo1_1280.jpg","http://25.media.tumblr.com/tumblr_lqybq53rCI1qjimsvo1_1280.png","http://25.media.tumblr.com/tumblr_lz7me0Y6JU1qgjltdo1_1280.jpg","http://24.media.tumblr.com/tumblr_lggvvf2mCm1qgnva2o1_500.gif"];

},{"cycle-snabbdom":5,"rx":23}]},{},[1]);
